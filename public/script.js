document.addEventListener('DOMContentLoaded', () => {
    ...
    const HUMOROUS_APHORISMS = [
        "ИИ размышляет о погоде...",
        "Собираю данные из небесной канцелярии...",
        "Анализирую движение облаков (и своих мыслей)...",
        "Погода - это как настроение, только за окном...",
        "Спрашиваю у ветра, куда он дует...",
        "Даже для ИИ погода - загадка...",
        "Проверяю, не забыл ли я свой цифровой зонтик...",
        "Минутку, сверяюсь с барометром и здравым смыслом...",
        "Погода сегодня достойна отдельного романа...",
        "Идеальный день, чтобы остаться дома и писать код..."
    ];
    ...
    // Функция для генерации юмористического афоризма
    function generateHumorousAphorism() {
        return HUMOROUS_APHORISMS[Math.floor(Math.random() * HUMOROUS_APHORISMS.length)];
    }
